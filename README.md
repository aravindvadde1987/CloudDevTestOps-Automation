# Project Base for CloudDevTestOps With Intelligent Automation

This project can be used as a starting point to create your own application with Spring Boot.
